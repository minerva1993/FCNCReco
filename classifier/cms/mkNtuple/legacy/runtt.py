...
for hut in range(0, 16):
  runAna("/data/users/minerva1993/ntuple_Run2016/v4/production/signalReco/TT_TopLeptonicDecay_TH_1L3B_Eta_Hut","Tree_ttbbLepJets_"+str(hut)+".root","TopHut_"+str(hut))
