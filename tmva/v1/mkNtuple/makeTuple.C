...
void makeTuple::Terminate()
{
  ...
  TFile *hfile = TFile::Open(Form("/home/minerva1993/recoFCNC/tmva/v1/mkNtuple/temp/tmva_%s.root",option.Data()),"RECREATE");
