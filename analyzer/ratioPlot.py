...
AddBkg("hist_ttother.root","ttLF",ROOT.kRed, 365.3)
...
"""
AddHct("hist_TopHct.root", "Hct", 433, 1.85)
AddHct("hist_AntiTopHct.root", "Hct", 433, 1.85) 
AddHut("hist_TopHut.root", "Hut", 401, 1.85)
AddHut("hist_AntiTopHut.root", "Hut", 401, 1.85)
AddSTHct("hist_singleTopHct.root", "STHct", 801, 1.38)
AddSTHut("hist_singleTopHut.root", "STHut", 901, 0.19)
